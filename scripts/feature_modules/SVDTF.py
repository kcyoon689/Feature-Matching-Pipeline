...
class SVDTF():
    ...
    def run(self, feature_df0: pd.DataFrame, feature_df1: pd.DataFrame) -> Tuple[np.array, np.array, np.array]:
        # 1. Finding the centroids
        feature_df0_mean = np.array(
            [np.mean(feature_df0[1]), np.mean(feature_df0[0])])
        feature_df1_mean = np.array(
            [np.mean(feature_df1[1]), np.mean(feature_df1[0])])
        ...
        feature_df0_unbiased = [
            feature_df0[1] - feature_df0_mean[1], feature_df0[0] - feature_df0_mean[0]]
        feature_df1_unbiased = [
            feature_df1[1] - feature_df1_mean[1], feature_df1[0] - feature_df1_mean[0]]
